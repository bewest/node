...
# Windows x86 MASM
#
mkdir -p asm/x86-win32-masm
mkdir -p asm/x86-win32-masm/aes
mkdir -p asm/x86-win32-masm/bf
mkdir -p asm/x86-win32-masm/bn
mkdir -p asm/x86-win32-masm/camellia
mkdir -p asm/x86-win32-masm/cast
mkdir -p asm/x86-win32-masm/des
mkdir -p asm/x86-win32-masm/md5
mkdir -p asm/x86-win32-masm/rc4
mkdir -p asm/x86-win32-masm/rc5
mkdir -p asm/x86-win32-masm/ripemd
mkdir -p asm/x86-win32-masm/sha
mkdir -p asm/x86-win32-masm/whrlpool
( cd openssl/crypto/aes/asm      && perl aes-586.pl    win32 ) > asm/x86-win32-masm/aes/aes-586.asm
( cd openssl/crypto/bf/asm       && perl bf-686.pl     win32 ) > asm/x86-win32-masm/bf/bf-686.asm
( cd openssl/crypto/bn/asm       && perl x86-mont.pl   win32 ) > asm/x86-win32-masm/bn/x86-mont.asm
( cd openssl/crypto/bn/asm       && perl x86.pl        win32 ) > asm/x86-win32-masm/bn/x86.asm
( cd openssl/crypto/camellia/asm && perl cmll-x86.pl   win32 ) > asm/x86-win32-masm/camellia/cmll-x86.asm
( cd openssl/crypto/cast/asm     && perl cast-586.pl   win32 ) > asm/x86-win32-masm/cast/cast-586.asm
( cd openssl/crypto/des/asm      && perl crypt586.pl   win32 ) > asm/x86-win32-masm/des/crypt586.asm
( cd openssl/crypto/des/asm      && perl des-586.pl    win32 ) > asm/x86-win32-masm/des/des-586.asm
( cd openssl/crypto/md5/asm      && perl md5-586.pl    win32 ) > asm/x86-win32-masm/md5/md5-586.asm
( cd openssl/crypto/rc4/asm      && perl rc4-586.pl    win32 ) > asm/x86-win32-masm/rc4/rc4-586.asm
( cd openssl/crypto/rc5/asm      && perl rc5-586.pl    win32 ) > asm/x86-win32-masm/rc5/rc5-586.asm
( cd openssl/crypto/ripemd/asm   && perl rmd-586.pl    win32 ) > asm/x86-win32-masm/ripemd/rmd-586.asm
( cd openssl/crypto/sha/asm      && perl sha1-586.pl   win32 ) > asm/x86-win32-masm/sha/sha1-586.asm
( cd openssl/crypto/sha/asm      && perl sha256-586.pl win32 ) > asm/x86-win32-masm/sha/sha256-586.asm
( cd openssl/crypto/sha/asm      && perl sha512-586.pl win32 ) > asm/x86-win32-masm/sha/sha512-586.asm
( cd openssl/crypto/whrlpool/asm && perl wp-mmx.pl     win32 ) > asm/x86-win32-masm/whrlpool/wp-mmx.asm
( cd openssl/crypto              && perl x86cpuid.pl   win32 ) > asm/x86-win32-masm/x86cpuid.asm
